...
class PatchSuggestionEnv(gym.Env):
    ...
    def __init__(self, vulnerability_context):
        ...
        self._current_state = self._embedding_to_numpy(self.vulnerability_context['embedding'])

    def _embedding_to_numpy(self, embedding_tensor):
        """Converts a PyTorch tensor to a numpy array for the Gym environment."""
